...
// SetUserPhoneNumber sets the "user_phone_number" field.
func (m *UserMutation) SetUserPhoneNumber(s string) {
	m.user_phone_number = &s
}

// UserPhoneNumber returns the value of the "user_phone_number" field in the mutation.
func (m *UserMutation) UserPhoneNumber() (r string, exists bool) {
	v := m.user_phone_number
	if v == nil {
		return
	}
	return *v, true
...
// OldUserPhoneNumber returns the old "user_phone_number" field's value of the User entity.
// If the User object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserMutation) OldUserPhoneNumber(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldUserPhoneNumber is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldUserPhoneNumber requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldUserPhoneNumber: %w", err)
	}
	return oldValue.UserPhoneNumber, nil
}

// ResetUserPhoneNumber resets all changes to the "user_phone_number" field.
func (m *UserMutation) ResetUserPhoneNumber() {
	m.user_phone_number = nil
}
...
func (m *UserMutation) SetUserBirthday(s string) {
	m.user_birthday = &s
}

// UserBirthday returns the value of the "user_birthday" field in the mutation.
func (m *UserMutation) UserBirthday() (r string, exists bool) {
	v := m.user_birthday
	if v == nil {
		return
	}
...
// OldUserBirthday returns the old "user_birthday" field's value of the User entity.
// If the User object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserMutation) OldUserBirthday(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *UserMutation) ResetUserBirthday() {
	m.user_birthday = nil
}
...
func (m *UserMutation) Fields() []string {
	...
	if m.user_phone_number != nil {
		fields = append(fields, user.FieldUserPhoneNumber)
	}
	if m.user_password != nil {
		fields = append(fields, user.FieldUserPassword)
	}
	if m.user_birthday != nil {
		fields = append(fields, user.FieldUserBirthday)
	}
	if m.created_at != nil {
...
func (m *UserMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	...
	case user.FieldUserPhoneNumber:
		return m.OldUserPhoneNumber(ctx)
	case user.FieldUserPassword:
