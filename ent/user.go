...
type User struct {
	...
	// UserPhoneNumber holds the value of the "user_phone_number" field.
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldUserEmail, user.FieldUserPhoneNumber, user.FieldUserPassword, user.FieldUserBirthday:
...
func (u *User) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case user.FieldUserPhoneNumber:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field user_phone_number", values[i])
			} else if value.Valid {
				u.UserPhoneNumber = value.String
			}
...
func (u *User) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("user_phone_number=")
	builder.WriteString(u.UserPhoneNumber)
	builder.WriteString(", ")
	builder.WriteString("user_password=")
	builder.WriteString(u.UserPassword)
	builder.WriteString(", ")
	builder.WriteString("user_birthday=")
	builder.WriteString(u.UserBirthday)
	builder.WriteString(", ")
